...
public class DefineMenuTutorial extends Activity {
    TextView tv_test;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_define_menu_tutorial);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_normal:
                Toast.makeText(DefineMenuTutorial.this, "这是普通菜单项", Toast.LENGTH_SHORT).show();
                break;
